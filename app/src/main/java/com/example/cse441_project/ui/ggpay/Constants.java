...
package com.example.cse441_project.ui.ggpay;
...
public class Constants {
    public static final String CURRENCY_VN = "VND"; // Mã tiền tệ là VND
    public static final String COUNTRY_VN = "VN"; // Mã quốc gia là VN
  /**
