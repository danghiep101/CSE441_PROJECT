...
package com.example.cse441_project.ui.ggpay.util;

import android.content.Context;


import com.example.cse441_project.ui.ggpay.Constants;
...
public class PaymentsUtil {
  ...
  private static JSONObject getTransactionInfo(String price) throws JSONException {
    return new JSONObject()
            .put("totalPrice", price) // Đảm bảo rằng giá trị này là số VND
            .put("totalPriceStatus", "FINAL")
            .put("countryCode", Constants.COUNTRY_VN) // Mã quốc gia là VN
            .put("currencyCode", Constants.CURRENCY_VN) // Mã tiền tệ là VND
